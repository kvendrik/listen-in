# Vendored from collabora/WhisperLive v0.8.0 — the PyPI `whisper-live` wheel does not ship `run_server.py`,
# and `python -m whisper_live.server` exits immediately (no `__main__` block).
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=50,
        help="Maximum time in ms for batch to fill (default: 50).",
    )
